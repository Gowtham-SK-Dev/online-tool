    ...
    <div className="container mx-auto py-8">
      ...
      <div className="prose prose-sm md:prose-base lg:prose-lg dark:prose-invert max-w-none">
        ...
        <p>
          ...
          cookies and web beacons to collect data about your visits to this and other websites in order to provide
        ...
        <p>We have implemented the following Google AdSense features:</p>
        <ul>
          <li>Google AdSense for Content</li>
          <li>Google AdSense for Search</li>
          <li>Google AdSense Matched Content</li>
        </ul>
        <p>
          These features may use cookies to serve ads based on your prior visits to our website or other websites.
